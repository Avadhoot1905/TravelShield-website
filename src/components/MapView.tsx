...
export default function MapView(props: MapViewProps) {
  ...
  const heatZones = useMemo(
    (): HeatZone[] => [
      ...
      {
        id: "zone-4",
        center: { lat: 27.4728, lng: 95.0388 },
        radius: 500,
        type: "red",
        intensity: 1.0,
      }, // Dibrugarh
      ...
      {
        id: "zone-6",
        center: { lat: 27.5889, lng: 95.9692 },
        radius: 500,
        type: "red",
        intensity: 1.0,
      }, // Pasighat
      {
        id: "zone-7",
        center: { lat: 28.0667, lng: 95.3333 },
        radius: 400,
        type: "red",
        intensity: 1.0,
      }, // Ziro
      ...
      {
        id: "zone-10",
        center: { lat: 25.5167, lng: 91.2667 },
        radius: 400,
        type: "red",
        intensity: 1.0,
      }, // Nongstoin
      ...
      {
        id: "zone-13",
        center: { lat: 25.1167, lng: 94.3667 },
        radius: 400,
        type: "red",
        intensity: 1.0,
      }, // Ukhrul
      ...
      {
        id: "zone-16",
        center: { lat: 22.4833, lng: 92.7167 },
        radius: 400,
        type: "red",
        intensity: 1.0,
      }, // Saiha
      ...
      {
        id: "zone-17",
        center: { lat: 25.6667, lng: 94.1167 },
        radius: 600,
        type: "red",
        intensity: 1.0,
      }, // Kohima
      ...
      {
        id: "zone-20",
        center: { lat: 23.8315, lng: 91.2862 },
        radius: 600,
        type: "red",
        intensity: 1.0,
      }, // Agartala
      ...
      {
        id: "zone-24",
        center: { lat: 27.3333, lng: 88.6167 },
        radius: 400,
        type: "red",
        intensity: 1.0,
      }, // Namchi
  ...
  const layers = useMemo(() => {
      ...
      for (let i = 0; i < steps; i++) {
        ...
        for (let r = 0; r < 10; r++) {
          ...
          const lng =
            zone.center.lng +
            (distance /
              (111000 * Math.cos((zone.center.lat * Math.PI) / 180))) *
              Math.sin(angle);
    ...
    const heatmap = new HeatmapLayer({
      ...
      getColorWeight: (d: { distance: number }) => d.distance,
    });
    ...
    const touristIcons = new IconLayer({
      ...
      getAngle: (d: { direction: number }) => d.direction,
